...
export default class Settings {
  ...
  static _FLAGS_MAPPING = {
    ...
    [Permalink.OPTIONS.PROGRESSION_MIXED_SECRET_CAVES]: [this.FLAGS.MIXED_SECRET_CAVE],
    ...
    [Permalink.OPTIONS.PROGRESSION_LONG_COMBAT_TRIALS]: [this.FLAGS.LONG_COMBAT_TRIAL],
    ...
    [Permalink.OPTIONS.PROGRESSION_SHORT_MINIGAMES]: [this.FLAGS.SHORT_MINIGAME],
    [Permalink.OPTIONS.PROGRESSION_LONG_MINIGAMES]: [this.FLAGS.LONG_MINIGAME],
